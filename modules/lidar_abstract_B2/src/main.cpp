...
uint32_t counter = 0;//lidr计数器，用于区分是否是最新的lidar数据
...
void LidarParsing()
{
	...
	sampleLidar->header.frameId = "B2";  //坐标
...
int main() 
{
	...
	**/
	...
	// 注册ros发布者
	pcPointXYZIRPub = mdc::visual::Publisher::Advertise<mdc::visual::PointCloud2>(ara::core::String("hwPtClound_B2"));// 原始点云的话题
