...
class ZcData {
public:
    ZcData() : HB(0), RED_Alarm(0), Yellow_Alarm(0), Coup_Status(0),
               Station(0), Direction(0), LocoSpd(0), LocoTime(0),
               Run_Mode(0), Station_Num(0)
    {
