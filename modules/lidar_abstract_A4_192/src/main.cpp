...
void LidarParsing()
{
	...
	sampleLidar->width  = points.size()/192;
	sampleLidar->height = 192;
...
int main() 
{
	...
	**/
	...
	// 注册ros发布者
	pcPointXYZIRPub = mdc::visual::Publisher::Advertise<mdc::visual::PointCloud2>(ara::core::String("hwPtClound_A4_192"));// 原始点云的话题
